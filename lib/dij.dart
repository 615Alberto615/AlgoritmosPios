...
class Home8 extends StatefulWidget {
  ...
  @override
  State<Home8> createState() => HomeState8();
}

class HomeState8 extends State<Home8> {
                ...
                children: [
                  ...
                  IconButton(
                    ...
                    onPressed: () async {
                      ...
                      if (nodoInicioSeleccionado.key !=
                        ...
                        List<int> caminoOptimo = dijkstra(
                          nodoInicioSeleccionado
                              .key, // Enviar la clave del nodo de inicio seleccionado
                          nodoDestinoSeleccionado
                              .key, // Enviar la clave del nodo de destino seleccionado
                        );
                        print('Camino óptimo: $caminoOptimo');
                        for (int i = 0; i < caminoOptimo.length - 1; i++) {
                          int nodo1 = caminoOptimo[i];
                          int nodo2 = caminoOptimo[i + 1];
                        ...
                        Future.delayed(Duration.zero, () {
                          mostrarCaminoOptimo(context, caminoOptimo);
                        });
                      } else {
                        print(
                  ...
                  IconButton(
                    ...
                    onPressed: () async {
                      ...
                      if (nodoInicioSeleccionado.key !=
                          nodoDestinoSeleccionado.key) {
                        List<int> caminoOptimo = dijkstraMax(
