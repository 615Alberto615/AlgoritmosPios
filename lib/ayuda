      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            Text(
                "Este botón calcula/genera los atributos segun el peso de las aristas conectadas."),
            IconButton(
            ...
            Text(
                "Este botón calcula/genera las holguras en cada linea para poder demostrar el camino más optimo."),
          ],
        ),
      ),
    );
