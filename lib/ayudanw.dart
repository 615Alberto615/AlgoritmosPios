...
class Ayudanw extends StatefulWidget {
  const Ayudanw({super.key});

  @override
  State<Ayudanw> createState() => _AyudaState();
}

class _AyudaState extends State<Ayudanw> {
  @override
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            Text(
                "Este botón permite agregar los valores de oferta para los nodos de origen y los valores de demanda para los nodos de destino."),
          ],
        ),
      ),
    );
